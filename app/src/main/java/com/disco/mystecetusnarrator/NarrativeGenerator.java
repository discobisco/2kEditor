...
public final class NarrativeGenerator {
    ...
    public static String generate(DetectionRecord r) {
        boolean one=singular(r.get("bestCount")); StringBuilder n=new StringBuilder("At ").append(utc(required(r,"initialTime"))).append(", ");
    ...
    private static String pilingSentence(String s){String l=s.toLowerCase(Locale.US);if(l.contains("no active piling")&&l.contains("delay"))return "No piling mitigation was needed because there was no active piling during the detection and piling was under a detection delay.";if(l.contains("no active piling"))return "No piling mitigation was needed because there was no active piling during the detection.";if(l.contains("detection delay"))return "Piling was under a detection delay during the detection.";if(l.contains("active piling"))return "Active piling was occurring during the detection.";return ensureSentence(s);}
